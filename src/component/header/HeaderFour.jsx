...
class HeaderFour extends Component{
    ...
    render(){
        ...
        let logoUrl;
        if(logo === 'light'){
            logoUrl = <img src="/assets/images/logo/logo-light.png" alt="Candace Rogue Logo" />;
        }else if(logo === 'dark'){
            logoUrl = <img src="/assets/images/logo/logo-dark.png" alt="Candace Rogue Logo" />;
        }else if(logo === 'symbol-dark'){
            logoUrl = <img src="/assets/images/logo/Candace-Rogue-Logo-Dark.png" alt="Candace Rogue Logo" />;
        }else if(logo === 'all-dark'){
            logoUrl = <img src="/assets/images/logo/logo-all-dark.png" alt="Candace Rogue Logo" />;
        } else if(logo === 'symbol-light'){
            logoUrl = <img src="/assets/images/logo/logo-symbol-light.png" alt="Candace Rogue Logo" />;
        }else{
            logoUrl = <img src="/assets/images/logo/logo.png" alt="Candace Rogue Logo" />;
        }
