...
const featureList = [
    ...
    },
    {
        ...
        subtitle: 'The Candace Rogue code is awesome well documented code. And Its customization is very easily'
    },
    {
        icon: <FaSass/>,
    ...
    },
    {
        ...
        subtitle: 'Candace Rogue is faster loading speed. Candace Rogue create your theme so much faster '
    },
    {
        icon: <FiCommand/>,
        title: 'Modern Design',
        subtitle: 'TCandace Rogue is a modern creatuve design for Creative Agency , Personal Portfolio etc....'
    },
    {
        icon: <FiHeadphones/>,
    ...
    },
    {
        ...
        subtitle: 'Bootstrap comfortable is available in Candace Rogue . So layout changes is so much easily'
    }
]
                                ...
                                <div className="col-lg-8 col-xl-5">
                                    <div className="inner">
                                        <div className="logo text-left">
                                            <a href="/">
                                                <img src="/assets/images/logo/logo-all-dark.png" alt="Candace Rogue Images"/>
                                            </a>
                                        </div>
                                        <p className="title">Welcome to Candace Rogue Portfolio Website</p>
                                    ...
                                    <div className="faq-area">
                                        <Accordion className="accodion-style--1" preExpanded={'0'}>
                                            <AccordionItem >
                                                <AccordionItemHeading>
                                                    <AccordionItemButton>
                                                        What is Candace Rogue ? How does it work?
                                                    </AccordionItemButton>
                                                </AccordionItemHeading>
                                                <AccordionItemPanel>
                                                    <p>Welcome to Candace Rogue React Creative Agency, React Portfolio and Corporate Multi Purpose Template Built With React JS. NO jQuery!. It works too much faster loading speed and you can works too much comfortability. Candace Rogue create your website so much faster, use to use and Well Documented Codes for your customization.</p>
                                                </AccordionItemPanel>
                                            </AccordionItem>
                                            ...
                                            <AccordionItem>
                                                <AccordionItemHeading>
                                                    <AccordionItemButton>
                                                        How can I run Candace Rogue react template?
                                                    </AccordionItemButton>
                                                </AccordionItemHeading>
                                                <AccordionItemPanel>
                                                    <p>You can run Candace Rogue easily.
                                            ...
                                            <AccordionItem>
                                                ...
                                                <AccordionItemPanel>
                                                    <p>
                                                        Yes, We will get update the Candace Rogue. And you can get it any time. Next time we will comes with more feature.
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="inner text-center">
                                        <span>Purchase The Candace Rogue and Make Your Site super faster and easy.</span>
