                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                                    ...
                                    <p>My talents go far beyond design and development. If you'd like to read more about my processes in these discplines below click the service that peaks your interest. If you're curious about what I do in the "Upside-Down", follow your curiousity to my secret menu LinkTree</p>
                                </div>
                            </div>
                        </div>
